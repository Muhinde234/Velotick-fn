  ...
  return (
   <>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between mb-6 gap-4">
        <h1 className="text-xl font-semibold whitespace-nowrap order-1 md:order-none">Good Morning!</h1>
        ...
        <div className="flex items-center gap-2 shrink-0 order-2 md:order-3">
          ...
          <div className="flex items-center gap-2 bg-gray-300 hover:bg-gray-200 rounded-full pl-2 pr-3 py-1 transition-colors cursor-pointer">
            <img 
              ...
              alt="User avatar"
            />
            <span className="text-sm font-medium text-gray-700 whitespace-nowrap">Igirimpuhwe Dositha</span>
          </div>
        </div>
      </div>
   </>

      ...
      <div className="p-6">
        ...
        <div className="mb-6">
          ...
          <div className="flex gap-4 text-sm">
            <p className="text-gray-600">Departure: <span className="text-gray-800">10:00 am</span></p>
            <p className="text-gray-600">Arrival: <span className="text-gray-800">12:00 pm</span></p>
          </div>
        </div>

      ...
      <div className="flex items-center h-screen justify-center">
        <div className="flex flex-col max-w-screen-2xl justify-center items-center">
          ...
          <div className="flex flex-col items-center">
            <h1 className="font-bold text-dark mb-6 text-3xl">
              Page Not Found
            </h1>
            <p className="font-medium text-muted text-center">
              This page is still under development by the team, come back in
              later time.
            </p>
